      ...
      <div className="max-w-7xl mx-auto px-4 relative z-10">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 md:gap-8">
          {PROJECTS.map((project, index) => {
            ...
            const CardWrapper = isLinkable ? "a" : "div";
              ...
              >
                <CardWrapper
                  {...(isLinkable
                    ...
                    : {})}
                  className={`relative h-full flex flex-col bg-slate-950/80 backdrop-blur-md border border-white/10 rounded-2xl overflow-hidden transition-all duration-500 will-change-transform backface-hidden hover:border-blue-500/50 hover:shadow-[0_0_30px_rgba(59,130,246,0.15)] group-hover:-translate-y-2 ${
                ...
                >
                  ...
                  <div className="p-6 md:p-8 flex flex-col h-full">
                    ...
                    <div className="mb-6">
                      <h3 className="text-xl md:text-2xl font-extrabold text-white mb-3 group-hover:text-blue-300 transition-colors">
                        {project.title}
                      </h3>
                      <p className="text-slate-300 text-sm md:text-base leading-relaxed font-medium border-l-2 border-slate-700 pl-4">
                        {project.description}
                      </p>
                    </div>
                    ...
                    <div className="mt-auto pt-6 border-t border-white/10">
                      <div className="flex flex-wrap gap-2">
                        {project.tech.map((tech) => (
                          <span
                            key={tech}
                            className="flex items-center gap-1.5 px-2 py-1 md:px-3 md:py-1.5 rounded-md bg-slate-900 border border-slate-700 text-[10px] md:text-xs font-bold font-mono text-blue-100 transition-colors"
                          >
                            <Terminal size={10} />
                            {tech}
                          </span>
