      ...
      <div className="max-w-7xl mx-auto px-4 relative z-10">
        ...
        >
          <h2 className="text-4xl md:text-5xl font-extrabold text-white mb-6">
            Professional <span className="text-transparent bg-clip-text bg-linear-to-r from-cyan-400 to-blue-500">Certifications</span>
          </h2>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
          {CERTIFICATIONS.map((cert, index) => (
            ...
            >
              ...
              {/* Card Container - DARK GLASS THEME RESTORED */}
              <div className="relative h-full flex flex-col rounded-2xl bg-slate-900/40 backdrop-blur-md border border-white/10 hover:border-cyan-500/50 transition-all duration-300 hover:shadow-[0_0_30px_rgba(6,182,212,0.15)] group-hover:-translate-y-2 overflow-hidden">
                ...
                <div className="p-8 flex flex-col h-full relative z-10">
                  ...
                  {/* HEADER: MASSIVE COMPANY NAME (Our Schema) */}
                  ...
                  <div className="grow">
                    ...
                    <p className="text-sm text-slate-400 leading-relaxed mb-8 font-light border-l-2 border-slate-800 pl-4 group-hover:border-cyan-500/50 transition-colors">
                      {cert.description}
                    </p>
                  </div>
