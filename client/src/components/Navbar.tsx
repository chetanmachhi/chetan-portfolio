            ...
            {navs.map((item) => (
              <MagneticWrapper key={item}>
                <a
                  ...
                  className="group relative px-6 py-2 block"
                >
                  ...
                  <span className="relative z-10 text-lg font-bold text-slate-300 group-hover:text-white transition-colors duration-200">
                    {item}
                  </span>
                </a>
              </MagneticWrapper>
              ...
              <div className="flex flex-col space-y-4">
                {navs.map((item, i) => (
                  <motion.a
                    ...
                    className="flex items-center justify-between text-xl font-bold text-slate-300 hover:text-white hover:bg-white/5 p-4 rounded-xl transition-all duration-200"
                  >
                    {item}
